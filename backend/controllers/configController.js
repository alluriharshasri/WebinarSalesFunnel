  ...
  try {
    res.json({
      ...
      constants: {
        ...
        // Default Settings
        DEFAULT_REGISTRATION_FEE: APP_CONSTANTS.DEFAULT_REGISTRATION_FEE,
        DEFAULT_REGISTRATION_DEADLINE: APP_CONSTANTS.DEFAULT_REGISTRATION_DEADLINE,
        DEFAULT_WEBINAR_DATE: APP_CONSTANTS.DEFAULT_WEBINAR_DATE,
        ...
        DEFAULT_WEBINAR_FEATURES: APP_CONSTANTS.DEFAULT_WEBINAR_FEATURES
      }
    });
  } catch (error) {
